    ...
    <aside className="w-64 h-screen bg-[var(--card)] border-r border-[var(--border)] flex flex-col">
      ...
      <div className="p-3">
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2 bg-[var(--background)] border border-[var(--border)] rounded-lg text-sm text-[var(--muted)] hover:border-[var(--muted)] transition-colors text-left"
        >
          <Search className="w-4 h-4" />
          <span className="flex-1">Search...</span>
          <kbd className="hidden sm:inline-flex items-center gap-0.5 px-1.5 py-0.5 bg-[var(--card)] border border-[var(--border)] rounded text-[10px]">
            ⌘K
          </kbd>
        </button>
      </div>
